...
<!-- HK: Removed "then ls -a" from the instructions because Exercise 4 already asks for ls -a. Exercise 3 should just be pwd and Exercise 4 should just be ls -a. -->
...
<!-- HK: /model actually opens a menu to pick a model, not just prints the current one. -->
...
<!-- HK: This exercise and several others say to press 1 to allow but the actual Gemini CLI shows clickable buttons saying "Allow once", "Allow for this session", and "No, suggest changes" instead of a y/n text prompt. I made a minor update to the wording  -->
...
<!-- HK: The expected answer shows analysis.html as untracked but it won't show up because the .gitignore Gemini creates ignores *.html files. Students might be confused why their output looks different. -->
