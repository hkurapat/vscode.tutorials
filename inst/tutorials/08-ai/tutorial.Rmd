...
<!-- HK: Added new-r-terminal.png to images folder showing how to create a new R Terminal from the dropdown menu. -->

```{r}
knitr::include_graphics("images/new-r-terminal.png")
```
