...
```{r}
include_graphics("images/analysis-1-post-ciommit.png")
```
...
```{r}
include_graphics("images/analysis-1-post-sync")
```
...
<!-- AR: We should publish first and then do the final commit. -->
