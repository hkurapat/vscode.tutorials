...
<!-- HK: When I ran show_file() the output was simpler than the expected answer suggested. Students should be warned output may vary -->
```{r project-1-11}
question_text(NULL,
	answer(NULL, correct = TRUE),
	allow_retry = TRUE,
...
<!-- HK: The expected answer URL format may differ from what students see depending on whether they are updating an existing gh-pages or creating a new one -->
```{r project-1-13}
question_text(NULL,
	answer(NULL, correct = TRUE),
	allow_retry = TRUE,
...
<!-- HK: The expected answer shows the command but the output shown is incomplete -->
```{r project-2-6}
question_text(NULL,
	answer(NULL, correct = TRUE),
	allow_retry = TRUE,
