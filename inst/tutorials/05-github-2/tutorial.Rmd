...
<!-- Add more about R Terminal/QMD world in the first example. It works well in the second already. Really ought to just switch the first example with the second! AR: Should I do this? -->
...
AR: How relevant is this comment still? What should we do from it?-->

<!-- More explicit emphasis on QMD world versus R Terminal world. -->

<!-- Consider getting rid of palmerpenguins. AR: Why? What would be better?-->
...
<!-- AR: Okay to repeat repo and Codespace setup? -->
