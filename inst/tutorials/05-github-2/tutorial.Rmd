...
<!-- DK: Add an exercise or two where, after creating project-1, the student looks in github.com/codespaces, and sees that she has two codespaces operating. Important to keep track of the codespaces. Once done with project-1, delete the codespace. And then, at end, delete the codespace for project-2. Leave it to them to delete the codespace with the tutorial running in it.  -->
