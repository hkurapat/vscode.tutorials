...
````
@ppbds-student ➜ /workspaces/website-2 $ ls
README.md
...
"Source" the entire script with echo by clicking the dropdown arrow next to the Run button (▷) at the top right of the editor and selecting "Source File with Echo". This takes all the code from the script and feeds it, line-by-line, to the R Terminal. CP/CR.
