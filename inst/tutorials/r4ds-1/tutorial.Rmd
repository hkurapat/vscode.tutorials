...
<!-- AR: Okay to have this check here? Or intro? This is in line with the AI vignette in tutorial.helpers as of 05.11 pre meeting. -->

If you haven't already, use the `codespace-starter` template to create a new repo on GitHub and rename it `r4ds-1`. Then, open the `r4ds-1` repo on GitHub and create a Codespace from it.
...
<!-- AR: Should this chunk be labelled setup? -->
...
<!-- AR: Why are we skipping 5 lines here? -->
