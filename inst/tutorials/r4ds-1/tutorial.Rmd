...
Update your code in `analysis.qmd`. Place your cursor on the first line of this code and press `Cmd/Ctrl + Enter` to run each line in the R Terminal — since `Cmd/Ctrl + Enter` runs one line at a time, press it repeatedly until both the plot creation code and the save command are executed.
