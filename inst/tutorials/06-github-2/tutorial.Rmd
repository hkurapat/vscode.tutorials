...
<!-- HK: Confirmed this bug. When show_file() is called on a chunk that prints a tibble, it renders raw pagedtable HTML instead of showing the file contents. The fix likely needs to go in the show_file() function in the tutorial.helpers package, not in this tutorial file. -->
