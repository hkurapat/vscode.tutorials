...
<!--AR: Switch for a gen AI exercises? Is there some value in doing it by hand once? -->
...
<!-- AR: Could ask AI to improve labels/title/caption for the iris plot, then have students choose/edit the result. -->
...
<!-- AR: Good place to teach AI debugging: paste the YAML error into AI and ask what indentation mistake caused it. CP/CR response -->
...
<!-- AR: Should this require the integrated VS Code Chat Sidebar specifically. More introduction needed for that? -->
