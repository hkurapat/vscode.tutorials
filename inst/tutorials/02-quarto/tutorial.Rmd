...
<!-- AR: Should we explicitly say this assumes students are already inside a GitHub Codespace running VS Code in the browser? That context matters before any Terminal/Explorer instructions. Yes. -->
...
No. You should test it and make sure it works.
-->
...
Remove the above call to the shell. Just teach the short cut. Maybe mention, in the knowledge drop, that short cuts call underlying commands.
-->
