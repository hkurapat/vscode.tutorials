...
Yes. Use Gen AI. Ensure that our code is good. Maybe keep the knowledge drop which highlights some one good aspect of our code: use |> instead of %>%.
-->
...
No. Tutorial long enough already.
-->
