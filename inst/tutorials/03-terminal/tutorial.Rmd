...
<!-- AR: Okay to remove section? Not sure how to adapt for Codespaces. Please do! -->
...
````
@ppbds-student ➜ /workspaces/03-terminal/files (main) $ ls ~/Downloads/
@ppbds-student ➜ /workspaces/03-terminal/files (main) $
````

My `Downloads` directory is empty right now, so the Terminal just prints a new prompt.
...
````
@ppbds-student ➜ /workspaces/03-terminal/files (main) $ ls ~/Downloads/T*
/home/codespace/Downloads/TODO.txt
@ppbds-student ➜ /workspaces/03-terminal/files (main) $
````

The `*` is a wildcard character, meaning that the `ls` command should return all the files which begin with a capital `T`. For me, there is one such file in the `Downloads` directory.
...
````
@ppbds-student ➜ /workspaces/03-terminal/files (main) $ ls ~/Downloads/TODO.txt
/home/codespace/Downloads/TODO.txt
@ppbds-student ➜ /workspaces/03-terminal/files (main) $
````
...
Run ` mv /home/codespace/Downloads/TODO.txt .`. Run `ls` to confirm that you have moved the `TODO.txt` file from the `Downloads` directory to the current working directory. CP/CR.
...
````
@ppbds-student ➜ /workspaces/03-terminal/files (main) $ mv /home/codespace/Downloads/TODO.txt .
@ppbds-student ➜ /workspaces/03-terminal/files (main) $ ls
TODO.txt
@ppbds-student ➜ /workspaces/03-terminal/files (main) $
````
...
````
mv /home/codespace/Downloads/TODO.txt TODO_2.txt
````
...
````
@ppbds-student ➜ /workspaces/03-terminal/files (main) $ rm TODO.txt
...
<!-- AR: How to handle downloads? Drag and drop into workspace? Just ignore? Download it from the command line into the correct location.  -->
...
````
@ppbds-student ➜ /workspaces/03-terminal/grepping (main) $ mv ~/Downloads/grepping.txt .
