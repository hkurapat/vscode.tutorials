...
Create a new file and save it as `analysis.qmd`. Add a YAML header at the top with a title (`"Earthquakes and Movies"`) and your name as author. Render the document using `Cmd/Ctrl + Shift + K`.
