...
<!-- AR: This video provides a helpful overview of the quarto publish process but uses R Studio as IDE - is it worthwile to keep this link? -->
...
<!-- AR: Is this repo name okay? It's not super descriptive of the actual site and shows up. -->
...
<!-- AR: okay to use terminal? Show file menu path as well? -->
